...
input_dirs = [
    "../src/img/img_scraping/marguerite_fleur/",
    "../src/img/img_scraping/rose_rouge/",
    "../src/img/img_scraping/tulipe_jaune/"
]
output_dirs = [
    "../src/img/img_resized/marguerite_fleur_resized/",
    "../src/img/img_resized/rose_rouge_resized/",
    "../src/img/img_resized/tulipe_jaune_resized/"
]
output_vector_files = [
    "../src/vector_data/marguerite_fleur_vectors.npy",
    "../src/vector_data/rose_rouge_vectors.npy",
    "../src/vector_data/tulipe_jaune_vectors.npy"
]
